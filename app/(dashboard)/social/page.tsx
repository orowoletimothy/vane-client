...
const removeFriend = async (friendId: string) => {
  ...
  const handleCancelFriendRequest = async (friendId: string) => {
    try {
      await api.post(`/social/user/${user?._id}/cancel-friend-request`, {
        friendId,
      });
  ...
  const isIncomingRequest = (id: string) =>
    friendRequests.some((r) => r._id === id);
  const isOutgoingRequest = (id: string) =>
    outgoingRequests.some((r) => r._id === id);
                      ...
                      <div>
                        {friend ? (
                          ...
                          <Button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              handleCancelFriendRequest(result._id);
                            }}
                          >
                            Cancel Request
                          </Button>
                          ...
                          <Button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              handleSendFriendRequest(result._id);
                            }}
                          >
                            Add Friend
                          </Button>
        ...
        <Tabs defaultValue="friends" className="space-y-4">
          ...
          <TabsContent value="friends">
            ...
            <Dialog
              ...
              onOpenChange={setFriendProfileOpen}
            >
              <DialogContent>
                {friendProfile && (
                  <>
                    ...
                    <div className="mt-2 space-y-2">
                      ...
                      <div className="flex gap-2">
                        <Badge variant="outline">
                          🔥 {friendProfile.genStreakCount || 0} streak
                        </Badge>
                        <Badge variant="outline">
                          🏆 {friendProfile.longestStreak || 0} best
                        </Badge>
                      </div>
                    </div>
                    <div className="mt-4">
                    ...
                    {showNoteInput && (
                      <div className="mt-4 flex gap-2 items-center">
                        ...
                        <Button
                          size="sm"
                          onClick={
                            user && friendProfile ? handleSendNote : undefined
                          }

...
import { Camera, Save, Plane, User, Calendar, Award, Flame, AlertTriangle } from "lucide-react"
import { inter } from "@/lib/fonts"

export default function ProfilePage() {
  const { user, updateProfile, toggleVacationMode, getDisplayName } = useAuthStore()
            ...
            <div className="flex items-start space-x-6">
              <div className="relative">
                <Avatar className="w-24 h-24">
                  <AvatarImage src={user.profilePicture || "/placeholder.svg"} alt={getDisplayName()} />
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-amber-600">{user.genStreakCount}</div>
                    <div className="text-sm text-gray-600">Current Streak</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600">{user.longest_streak}</div>
                    <div className="text-sm text-gray-600">Longest Streak</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-purple-600">{user.recovery_points}</div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex space-x-2">
                  ...
                  {isEditing ? (
                    <div className="flex space-x-2">
                      <Button size="sm" onClick={handleSaveDisplayName} disabled={isSaving || !displayName.trim()}>
                        {isSaving ? (
                ...
                <p className="text-xs text-gray-500">This is how your name appears to others</p>
              </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-gray-600">Pause streak counting while you're away</p>
                </div>
                <Switch id="vacation-mode" checked={user.is_vacation} onCheckedChange={handleVacationToggle} />
              </div>
              ...
              {user.is_vacation && (
                <Alert>
                  ...
                  <AlertDescription>
                    Vacation mode is active. Your streaks won't be affected by missed days, but you also won't gain
                    streak days while this is enabled.
                  </AlertDescription>
                </Alert>
              )}
              ...
              <div className="space-y-3">
                <h4 className="font-medium text-gray-900">What happens in vacation mode?</h4>
